...
{
	/// <summary>
	///		An enumeration of possible authentication failure codes that may be returned by the CAS v2.0 service ticket validation endpoint.
	/// </summary>
	/// <remarks>
	...
	/// <summary>
	///		An object representing the CAS v2.0 response sent when authentication fails.
	/// </summary>
	public class AuthenticationFailureResponse
	{
		...
		/// <summary>
		///		Generates a JSON object string representing the CAS v2.0 authentication failure response.
		/// </summary>
		/// <returns>
		...
		/// <summary>
		///		Generates a XML object string representing the CAS v2.0 authentication failure response.
		/// </summary>
		/// <returns>
